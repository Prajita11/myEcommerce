...
export type Unnamed_1_Query = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', code: string, name: string, emoji: string }>, continents: Array<{ __typename?: 'Continent', name: string, code: string }>, country?: { __typename?: 'Country', name: string, code: string, capital?: string | null } | null };
